...
//     console.log(MonthlyScoutsData, 'getMonthlyScout');
...
//                         <CardComponents user="Total Scouts" count={ScoutsCountData[0]?.total} color="bg-card-blue" image="/assets/images/dashboard_data_1.png" />
//                         <CardComponents user="Active Users" count={ScoutsCountData[0]?.user} color="bg-card-orange" image="/assets/images/dashboard_data_2.png" />
//                         <CardComponents user="Active Un-Alloted Locations" count={ScoutsCountData[0]?.UnAllotedLocation} color="bg-card-dark" image="/assets/images/dashboard_data_3.png" />
//                         <CardComponents user="Alloted Locations" count={ScoutsCountData[0]?.AllotedLocation} color="bg-card-green" image="/assets/images/dashboard_data_4.png" />

//                         {/* <div className="overflow-hidden relative bg-card-blue block p-6 rounded-lg shadow">
//                             <div className="me-16">
//                                 <h5 className="mb-1 text-xl tracking-tight text-white w-max">Total Scouts</h5>
...
//                             <div className="me-16">
//                                 <h5 className="mb-1 text-xl tracking-tight text-white w-max">Active Users</h5>
//                                 <p className="mb-1 text-white text-5xl font-black">50</p>
//                                 <p className="text-white text-md">
...
//                             <div className="me-16">
//                                 <h5 className="mb-1 text-xl tracking-tight text-white w-max">Un-Allotted Locations</h5>
//                                 <p className="mb-1 text-white text-5xl font-black">50</p>
//                                 <p className="text-white text-md">
//                                     <span className="font-black">30</span> New in <span className="font-black">This Month</span>
//                                 </p>
...
//                             <div className="me-16">
//                                 <h5 className="mb-1 text-xl tracking-tight text-white w-max">Allotted Locations</h5>
//                                 <p className="mb-1 text-white text-5xl font-black">50</p>
//                                 <p className="text-white text-md">
//                                     <span className="font-black">30</span> New in <span className="font-black">This Month</span>
//                                 </p>
