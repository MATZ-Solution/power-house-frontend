...
const Header = () => {
    ...
    const userDetails = useSelector((state: any) => state.adminDetails);
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <div className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-xl  font-extrabold ltr:ml-1.5 rtl:mr-1.5   align-middle hidden md:inline dark:text-white-light transition-all duration-300">Power House</span>
                        </div>
                        <button
                            type="button"
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex justify-end space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
